...
<body>
	...
	<div class="container">
        ...
        <form action="GenNotice" method="post" enctype="multipart/form-data">
        <table border="1" cellpadding="5" 
        class="table table-sm auto" style="border-radius:10px;">
            
            <tr>
                <th style="background-color: orangered"></th>
                <th style="background-color: orangered">Subject</th>
                <th style="background-color: orangered">File</th>
                <th style="background-color: orangered">Submit</th>
                <th style="background-color: orangered"></th>
            </tr>
