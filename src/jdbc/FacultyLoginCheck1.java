...
@WebServlet("/FacultyLoginCheck1")
public class FacultyLoginCheck1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
    	...
    	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try 
	        {
				...
				PreparedStatement statement = con.prepareStatement("select count(*) from faculty11 where email=? and pass=?");
